...
item_1 = 10 # 19. Присвоить переменной item_1 odd значение
...
result_int = round(result_division) # 27. Создать переменную result_int и result_division округлить до ближайшего целого через явное приведение.
